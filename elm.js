...
Elm.Display.make = function (_elm) {
   ...
   var withMargin = F2(function (_v0,
   elt) {
      return function () {
         switch (_v0.ctor)
         {case "_Tuple2":
   ...
   var renderDeck = function (state) {
      return function () {
         ...
         _L.fromArray([A3($Graphics$Element.image,
                      ...
                      85,
                      20,
                      $Graphics$Element.midBottom)($Text.centered($Text.height(14)($Text.fromString(deckSizeStr))))]));
      }();
   };
   var renderScoreArea = function (state) {
      ...
      _L.fromArray([A3($Graphics$Element.container,
                   85,
                   30,
                   $Graphics$Element.middle)($Text.centered(A2(playerHandText,
                   $GameTypes.Red,
                   state)))
                   ...
                   85,
                   40,
                   $Graphics$Element.middle)($Text.centered(A2(playerScoreText,
                   $GameTypes.Red,
                   state))))
                   ,withMargin({ctor: "_Tuple2"
                               ,_0: 1
   ...
   var gameMargin = 15;
   var getTotalBoardSize = function (_v14) {
      return function () {
         switch (_v14.ctor)
         {case "_Tuple2":
            return _v14._1 - 2 * gameMargin;}
         _U.badCase($moduleName,
         "on line 56, column 37 to 61");
      }();
   };
   ...
   var mouseToBoardPosition = F3(function (_v18,
   state,
   dims) {
      return function () {
         switch (_v18.ctor)
         {case "_Tuple2":
            return function () {
                 ...
                 var y = _v18._1 - gameMargin;
                 var boardY = 0 - ((y / tileSize | 0) - offset);
                 var x = _v18._0 - gameMargin;
