...
Elm.Display.make = function (_elm) {
   ...
   state) {
      return function () {
         ...
         80,
         pieceSize,
         $Graphics$Element.middle)($Graphics$Element.leftAligned($Text.color($Player.toColor(player))((_U.eq(state.turn,
         ...
         25,
         pieceSize,
         $Graphics$Element.midLeft)($Graphics$Element.show($Maybe.withDefault(0)(A2($Dict.get,
         p,
         state.score))));
         var delta = A3($Graphics$Element.container,
         20,
         pieceSize,
         $Graphics$Element.midLeft)($Graphics$Element.leftAligned($Text.height(9)($Text.fromString($Maybe.withDefault("")(A2($Dict.get,
         p,
         state.delta))))));
      ...
      return function () {
         var logArea = $Graphics$Element.flow($Graphics$Element.down)($List.map(function (_v18) {
            return function () {
               ...
               _U.badCase($moduleName,
               "on line 211, column 49 to 99");
            }();
         })($List.take(5)(state.log)));
         var deckSizeArea = $State.isOngoing(state) ? A3($Graphics$Element.container,
         70,
         40,
         $Graphics$Element.middle)($Graphics$Element.centered($Text.height(11)($Text.fromString(A2($Basics._op["++"],
         "Deck: ",
         ...
         150,
         40,
         $Graphics$Element.middle)($Graphics$Element.centered($Text.height(11)($Text.fromString(remoteGameStatusText))));
         ...
         $Signal.message(gameTypeMailbox.address),
         _L.fromArray([{ctor: "_Tuple2"
                       ,_0: "Player vs AI"
...
Elm.Kalevala.make = function (_elm) {
   ...
   var processClick = function (signal) {
      return function () {
         ...
         var sampledGameType = $Signal.sampleOn(signal)($Display.gameTypeMailbox.signal);
